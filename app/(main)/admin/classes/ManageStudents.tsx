    ...
    <div className="space-y-6">
      <div>
        <div className="flex justify-between items-center mb-3">
            <h4 className="text-xs font-bold text-brand-dark uppercase">Student Terdaftar</h4>
            <span className="text-xs bg-gray-100 px-2 py-1 rounded-md font-bold">{currentEnrollments.length} Student</span>
        </div>
        
        <div className="space-y-2 max-h-60 overflow-y-auto pr-2">
          {currentEnrollments.length === 0 ? (
            <p className="text-sm text-gray-400 italic">Belum ada student di kelas ini.</p>
          ) : (
      ...
      <form action={formAction} className="space-y-3">
        ...
        <h4 className="text-xs font-bold text-brand-dark uppercase">Masukkan Student Manual</h4>
    ...
    return (
      <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-card p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h3 className="font-heading font-bold text-lg text-brand-dark">Atur Student</h3>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-brand-cream">
              <div>
                <h3 className="font-heading font-bold text-lg text-brand-dark">Daftar Student</h3>
                <p className="text-xs text-brand-gray">{classTitle}</p>
              </div>
